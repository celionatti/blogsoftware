...
$this->setHeader("Create Board Post");
...
<div class="container bg-white p-2 rounded">
    <h2 class="text-muted text-center">Create Board Post</h2>
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="row my-3">
            <div class="col">
                <a href="<?= Config::get('domain') ?>admin/board-posts" class="btn btn-danger w-100"><i class="bi bi-arrow-left-circle"></i>
                    cancel</a>
            </div>
            <div class="col">
