...
<div class="container bg-white p-2 rounded">
    ...
    <div class="border border-muted border-1 px-2 table-responsive">
        ...
        <form action="" method="post">
            ...
            <?= BootstrapForm::inputField("Amount", "amount", "", ['class' => 'form-control'], ['class' => 'form-floating my-2'], $errors) ?>

            <?= BootstrapForm::textareaField('Details of Transaction', 'details', $article->details ?? '', ['class' => 'form-control summernote'], ['class' => 'form-floating my-2'], $errors) ?>
