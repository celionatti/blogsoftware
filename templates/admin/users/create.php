...
<div class="container bg-white p-2 rounded">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        <div class="row">
            ...
            <?= BootstrapForm::inputField('First Name', 'name', '', ['class' => 'form-control'], ['class' => 'form-floating my-2 col'], $errors) ?>
        </div>

        <div class="row">
            <?= BootstrapForm::inputField('Username', 'username', '', ['class' => 'form-control'], ['class' => 'form-floating my-2 col'], $errors) ?>

            <?= BootstrapForm::inputField('E-Mail', 'email', '', ['class' => 'form-control', 'type' => 'email'], ['class' => 'form-floating my-2 col'], $errors) ?>
        </div>

        <div class="row">
            <?= BootstrapForm::inputField('Phone Number', 'phone', '', ['class' => 'form-control', 'type' => 'tel'], ['class' => 'form-floating my-2 col'], $errors) ?>
        ...
        <?= BootstrapForm::inputField('Social', 'social', '', ['class' => 'form-control', 'type' => 'url'], ['class' => 'form-floating my-2 col'], $errors) ?>

        <?= BootstrapForm::textareaField('Bio', 'bio', '', ['class' => 'form-control summernote'], ['class' => 'form-floating my-2'], $errors) ?>

        <div class="row my-3">
            <div class="col">
                <a href="/admin/users" class="btn btn-danger w-100"><i class="bi bi-arrow-left-circle"></i>
                    cancel</a>
            </div>
            <div class="col">
